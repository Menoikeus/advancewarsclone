...
public enum UnitType {
	INFANTRY("infantry", 4.0, 1.0, .5, 0.0, 3, false, false, 0, 0), 
	MECH("mech", 5.0, 1.2, 1.1, .05, 2, false, false, 18, 0);
	...
	private UnitType(String n, double s, double infM, double armorM, double dA, int mC, boolean iV, boolean iA, int tX, int tY)
	{
		name = n;
		this.strength = s;
